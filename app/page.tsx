...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col items-center justify-center p-6 selection:bg-[#7A8F66]/10">
      <div className="max-w-md w-full text-center space-y-6 sm:space-y-8 bg-white p-6 sm:p-10 rounded-[1.5rem] sm:rounded-[2.5rem] border border-[#F5F1EA] shadow-sm">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl sm:text-3xl font-black text-[#2D2D2D] tracking-tight">FACULTY PRO</h1>
